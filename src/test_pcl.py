...
def main():
    cloud = pcl.load(
        './pcd/table_scene_mug_stereo_textured.pcd')
    ...
    pcl.save(cloud_plane, './pcd/results/table_scene_mug_stereo_textured_plane.pcd')
    ...
    pcl.save(cloud_cylinder, './pcd/results/table_scene_mug_stereo_textured_cylinder.pcd')
